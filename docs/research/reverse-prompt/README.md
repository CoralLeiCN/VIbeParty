...
Current implementation: [one FastH3 session per round with30-second relay turns](session-reuse.md), following the user's latest instruction. Earlier provider research and separate-session evidence remain below.
